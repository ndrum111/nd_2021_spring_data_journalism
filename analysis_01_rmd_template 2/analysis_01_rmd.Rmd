...
population_women_killed <- fatal_police_shootings_data %>%
  group_by (gender) %>%
  summarise(women_percent=n()) %>%
  arrange(desc(women_percent)) 
  

# Display results of code below this codeblock

#There were 5816 men killed, 270 females and 1 N/A. Divide 270 by 5816 multiply it by 100 and get 4.64 percent. 
