...
# Q: How many cases did the average U.S. county have on August 30?
# A: On average, counties in the U.S. had 1907 cases on August 30.
...
# Q: How many **deaths** did the average U.S. county have on August 30?
# A: The average U.S.county had 58.29 covid related deaths on August 30.
...
# A:Alaska had 34 covid deaths as of August 30, the fewest of any state. 
...
# Write the answer in a comment
# Q: What was the average number of cases per county in each state? Which state had the lowest average?
# A: Vermont at the lowest average.
...
state_deaths_in_average_county <- covid_county %>%
  group_by(state) %>%
  summarise(total_deaths_in_average_county = mean(deaths)) %>%
  arrange(desc(total_deaths_in_average_county))
...
# A: New Jersey had the highest average deaths per county. 
...
# Write the answer in a comment
# Q: Which state has the most counties in our data? How many?
# A: Texas has the most counties in our data with 251. 
```
...
smallest_number_of_counties_per_state <- covid_county %>%
  group_by(state) %>%
  summarise(total_counties = n()) %>%
...
smallest_number_of_counties_per_state

# Q: which state has the smallest number of counties? 
# A: The District of Columbia has the smallest number of counties. 
...
```{r}
#Which state had the most covid deaths? How many deaths did they report?
...
#Name of object I created

most_covid_deaths_state

# Which state had the most covid deaths? How many deaths did they report?
# A: New York had the most covid deaths with 32534.
