...
covid_cases_per_thousand <- state_covid_population %>%
  mutate(cases_per_one_thousand = total_cases/population *1000) %>%
arrange(desc(cases_per_one_thousand))


# Answer: Louisiana had the highest number of COVID-19 cases per 1,000 people on August 30, 2020.
