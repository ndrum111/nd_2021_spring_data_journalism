...
```{r}
# covid county monthly death rate
...
# A: Prince George's County had 29 cases per 1,000, the highest case rate on August 30 in all of the Maryland counties.
```
...
# A: Greensville, Virginia had the highest case rate on August 30 with 61 cases per 1,000. (60.55 so round up)
...
# A:Two areas, Hancock, GA and Galax city, VA had a death rate above 4 per 1,000 in August.
...
# A: Kent County was the only Maryland county with a death rate higher than 1 per 1,000 in August.
...
# A: Galax city, Emporia city and Northampton were all Virginia areas with a death rate higher than 2 per 1,000 in August.
...
# Jones County had the smallest percentage change in cumulative case rates between May and August in the state of Texas. 
...
# Q: "Which county had the biggest jump in cumulative case rate between May and August?" 

covid_county_may_aug_change <- covid_county_monthly_case_rate %>%
  select(county, state, d_2020_05_30, d_2020_08_30) %>%
  mutate(may_aug_change = d_2020_08_30 - d_2020_05_30) %>%
  arrange(desc(may_aug_change))

# This code displays the results of the code we created above in the markdown document

covid_county_may_aug_change


# A:  Lafayette, Florida had the biggest jump in cumulative case rates between May and August. 
